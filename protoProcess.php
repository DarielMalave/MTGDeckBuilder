...
if (isset($_POST['reserve'])) {
	...
	if($time1 > $time2 || $startDate < $dateToday){
    ...
    if ($availability == 0) {
        ...
        $mysqli->query("INSERT INTO reservation (RES_NUM, RID, CID, TOTAL, START_DT, END_DT, RT_ID) VALUES('$lastNum', '0', '$userId', '$price', '$startDate', '$endDate', '$propId')") or die($mysqli->error);
